...
export default function Features(props){
    ...
    const headers = "text-2xl text-center py-2 font-semibold"
    const linksClass = "text-blue-500 font-semibold"
    return(
        <div className={`mx-3 lg:flex flex-col gap-5 hidden p-5 ${props.darkMode?darkMode:lightMode}`}>
        <input type="text" className="rounded-lg p-2 bg-zinc-50 border-2 " placeholder="Search"/>
        <article className="border-2 rounded-lg p-2 flex items-center">
            <p className="text-xl">Buy Premium</p>
