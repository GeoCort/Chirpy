...
function AddCommentBox(props){
    ...
    return(
        ...
        <textarea type="text" className="mx-5 bg-inherit p-2 my-3 text-xl " placeholder="Whats on your mind?" ></textarea>
...
export default function Timeline(props){
    ...
    return(
       <div className={` col-span-2 sm:col-span-1 flex flex-col text-white border-r-2 ${props.darkMode? darkMode:lightMode}`} >
